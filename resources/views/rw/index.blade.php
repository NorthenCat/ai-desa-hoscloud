                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                    <a href="{{ route('failed-files.show', ['desa'=>$rw->getDesa->id, 'rw'=>$localRwInstance->id, 'file'=>$file->id]) }}"
                                    ...
                                    <form
                                        action="{{ route('failed-files.destroy', [$rw->getDesa->id, $localRwInstance->id, $file->id]) }}"
                                        method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
